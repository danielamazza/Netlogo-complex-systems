...
to compute-direction-fractions
  ...
  set N-fraction (length filter [? = "N"] directions) / population
  set S-fraction (length filter [? = "S"] directions) / population
  set E-fraction (length filter [? = "E"] directions) / population
  set W-fraction (length filter [? = "W"] directions) / population
end
